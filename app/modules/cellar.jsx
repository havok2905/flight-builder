...
let Cellar = {
  ...
  styles: [
    ...
    { name: 'Wheat',       abv: [3,  5],  hops: [2, 4],  malt: [1,3],  sour: [0, 2]  },
    { name: 'Pale Ale',    abv: [5,  7],  hops: [5, 7],  malt: [2,3],  sour: [0, 0]  },
    { name: 'IPA',         abv: [6,  11], hops: [7, 10], malt: [2,5],  sour: [0, 0]  },
    { name: 'Scotch',      abv: [7,  9],  hops: [2, 3],  malt: [5,9],  sour: [0, 0]  },
    { name: 'Porter',      abv: [5,  7],  hops: [3, 5],  malt: [6,8],  sour: [0, 0]  },
